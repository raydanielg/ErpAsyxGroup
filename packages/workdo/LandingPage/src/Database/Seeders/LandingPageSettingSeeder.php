...
class LandingPageSettingSeeder extends Seeder
{
    ...
    private function getDefaultSettings(): array
    {
        return [
            'company_name' => 'Zerixa',
            'contact_email' => 'support@Zerixasaas.com',
    ...
    private function getDefaultSections(): array
    {
        return [
            'hero' => [
                ...
                'subtitle' => 'Streamline your entire business lifecycle, from finance to operations, with Zerixa. One platform, infinite possibilities.',
                'primary_button_text' => 'Start Free Trial',
                'primary_button_link' => route('register'),
                'secondary_button_text' => 'Login',
                'secondary_button_link' => route('login'),
                'highlight_text' => 'Zerixa',
            ...
            'cta' => [
                ...
                'subtitle' => 'Join thousands of businesses already using Zerixa to streamline their operations.',
