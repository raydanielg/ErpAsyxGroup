...
class DefultSetting extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin_settings = [
            ...
            'favicon' => 'favicon.png',
            'titleText' => !empty(env('APP_NAME')) ? env('APP_NAME') : 'Zerixa',
            'footerText' => 'Copyright © ' . (!empty(env('APP_NAME')) ? env('APP_NAME') : 'Zerixa'),
            ...
            // SEO Settings
            'metaKeywords' => 'Zerixa, workdo, dashboard, admin, panel, management',
            'metaTitle' => !empty(env('APP_NAME')) ? env('APP_NAME') . ' - Dashboard' : 'Zerixa - Dashboard',
